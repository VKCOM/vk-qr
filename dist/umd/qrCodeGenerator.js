...
var qrcodegen = new function () {
  ...
  this.QrCode = function (version, errCorLvl, dataCodewords, mask) {
    ...
    this.toSvgString = function () {
      var width = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : DEFAULT_SIZE;
      var height = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : DEFAULT_SIZE;
  ...
  this.createQR = function (text) {
    var width = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : DEFAULT_SIZE;
    var height = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : DEFAULT_SIZE;
    var className = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : '';

    var segs = _this.QrSegment.makeSegments(text);
    var svg = _this.QrCode.encodeSegments(segs, _this.QrCode.Ecc.QUARTILE, 1, 40, -1, true).toSvgString(width, height, className);
    return svg;
  };
