...
var qrcodegen = new function() {
  ...
  this.QrCode = function(version, errCorLvl, dataCodewords, mask) {
    ...
    this.toSvgString = function(qrSize = DEFAULT_SIZE, className = '', options = {}) {
      ...
      const pixelSize = 99 * size;
      let qrBackground = '';
      let qrTransform = 'translate(25,25)';
      if (isShowBackground) {
        let padding = (pixelSize / qrSize) * BACKGROUND_RADIUS;
        let radius = Math.ceil(pixelSize / 7.11);   // 7.11111111 = 256px/36px radius
