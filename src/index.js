...
var qrcodegen = new function() {
  ...
  this.qrBorder = 7;
  this.tileSize = 97 * multi;
  this.incTileSize = 97 * multi;
  ...
  this.QrCode = function(version, errCorLvl, dataCodewords, mask) {
    ...
    this.toSvgString = function(qrSize = DEFAULT_SIZE, className = '') {
      ...
      return `<svg version="1.1" viewBox="0 0 ${100 * size} ${100 * size}" width="${qrSize}px" heigth="${qrSize}px"${className ? ` class="${className}"` : ''} xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
